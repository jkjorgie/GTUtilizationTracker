...
import { beginTotpEnrollment, confirmTotpEnrollment } from "@/app/actions/totp";
...
export default function SetupMfaPage() {
  ...
  useEffect(() => {
    beginTotpEnrollment()
      ...
      .catch((err) => {
        setInitError(err instanceof Error ? err.message : "Failed to start setup. Please try again.");
      });
  }, []);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await confirmTotpEnrollment(code.trim());
      router.push("/");
      router.refresh();
    } catch (err) {
